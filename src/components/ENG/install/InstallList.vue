      ...
      <div class="content flex-column">
        <div class="fixed">
            <van-tabs @click="onNav">
              <van-tab title="待安装" name='1'></van-tab>
              <van-tab title="已安装" name='2'></van-tab>
            </van-tabs>
        </div>
        <van-list
          class="list"
...
export default {
  data() {
    return {
      ...
      num:1,
      status:1,
      url:'/wx/engineer/api/installList'
    };
  },
  methods: {
    onNav(name, title){
      if(title == '待安装'){
        this.url = '/wx/engineer/api/installList'
        this.list = [];
        this.loading = true;
        this.finished = false;
        this.num = 1;
        ...
        this.url = '/wx/engineer/api/alreadyInstallList'
        this.list = [];
        this.loading = true;
        this.finished = false;
        this.num = 1;
